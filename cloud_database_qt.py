...
class CloudDatabaseManager:
    ...
    def _initialize_connection_pool(self):
        ...
        if not database_url or not database_url.startswith("postgres"):
            default_url = "postgres://swiftsale:6lqf31ksFS1KSfs1PAYdnMEJyvBSkgOe@dpg-d1fgjrndiees73bol7tg-a.virginia-postgres.render.com/swiftsale_db"
            self.log_info(f"DATABASE_URL not set or invalid; using default: {default_url}")
